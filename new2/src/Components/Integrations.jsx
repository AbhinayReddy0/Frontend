...
const INTEGRATIONS = [
    { id: 1, name: "Shopify", desc: "Sync orders, products and inventory from your Shopify store in real time.", logo: "https://cdn.brandfetch.io/idAgPm7IvG/theme/light/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1720758863442" },
    { id: 2, name: "Amazon", desc: "Connect your Amazon Seller Central account for automated fulfillment.", logo: "https://cdn.brandfetch.io/idawOgYOsG/theme/light/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1747149760643" },
    { id: 3, name: "Walmart", desc: "Manage Walmart Marketplace listings, orders and returns seamlessly.", logo: "https://cdn.brandfetch.io/idoGsFQrHx/theme/light/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1756891476083" },
    { id: 4, name: "ShipBob", desc: "Automate fulfillment, shipping logistics and warehouse management.", logo: "https://cdn.brandfetch.io/idkccMhoPZ/theme/light/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1692720649718" },
    { id: 5, name: "Xero", desc: "Sync invoices, expenses and accounting data directly with Xero.", logo: "https://cdn.brandfetch.io/idvAAbnIRW/theme/dark/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1667577419075" },
    { id: 6, name: "QuickBooks", desc: "Connect QuickBooks for seamless bookkeeping and financial reporting.", logo: "https://cdn.brandfetch.io/idYwh2MQCX/w/400/h/400/theme/dark/icon.png?c=1bxid64Mup7aczewSAYMX&t=1772986840240" },
    { id: 7, name: "Cin7", desc: "End-to-end inventory and order management powered by Cin7.", logo: "https://cdn.brandfetch.io/idV9mVKQne/theme/light/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1668014875407" },
    { id: 8, name: "Google Sheets", desc: "Export, sync and collaborate on your data via Google Sheets.", logo: "https://cdn.brandfetch.io/id6O2oGzv-/theme/dark/idKa2XnbFY.svg?c=1bxid64Mup7aczewSAYMX&t=1755572735234" },
];
...
const ConnectModal = ({ open, onClose, integration, onConnect }) => {
    ...
    const handleConnect = () => { onConnect(integration.id); onClose(); };
    ...
    return (
        <Dialog
            ...
            PaperProps={{
                sx: {
                    bgcolor: "#111", border: "1px solid #2a2a2a", borderRadius: "16px",
            ...
            <DialogContent sx={{ p: 0 }}>
                ...
                <Box sx={{ px: 3, pt: 2.5, pb: 3 }}>
                    ...
                    {fields.filter((f) => f.type !== "oauth_notice").map((field) => {
                            ...
                            <Box key={field.key} sx={{ mb: 2.5 }}>
                                ...
                                <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                                    {field.options.map((opt) => (
                                        <Chip key={opt} label={opt} clickable onClick={() => handleChange(field.key, opt)}
                                            sx={{
                        ...
                        return (
                            <TextField
                                key={field.key} fullWidth label={field.label} placeholder={field.placeholder}
    ...
    return (
        ...
        >
            ...
            <Box sx={{ mb: 4, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <Box>
                    <Typography variant="h5" fontWeight={700} letterSpacing="-0.5px" color="#f0f0f0">
                        Integrations
                    </Typography>
                    <Typography variant="body2" sx={{ color: "#555", mt: 0.5, fontSize: 13 }}>
            ...
            <Box sx={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 3 }}>
                            ...
                            <CardContent sx={{ flexGrow: 1, p: 2.5 }}>
                                <Box sx={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", mb: 2 }}>
                                    <Box sx={{ width: 44, height: 44, bgcolor: "#161616", border: `1px solid ${connected ? "#1a3a1a" : "#242424"}`, borderRadius: "12px", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", p: "8px" }}>
                                        <Box component="img" src={item.logo} alt={item.name} sx={{ width: "100%", height: "100%", objectFit: "contain" }} />
                                    </Box>
                                    {connected && (
                                ...
                                <Typography variant="body2" sx={{ color: "#555", lineHeight: 1.65, fontSize: 12.5 }}>
                                    {item.desc}
                                </Typography>
                            </CardContent>
                ...
                {/* Manual Upload card */}
                <Card onClick={() => setUploadOpen(true)} sx={{ bgcolor: "#0c0c0c", border: "1px dashed #282828", borderRadius: "14px", color: "#fff", display: "flex", flexDirection: "column", cursor: "pointer", transition: "border-color 0.2s, transform 0.15s", "&:hover": { borderColor: "#444", transform: "translateY(-2px)" } }}>
                    <CardContent sx={{ flexGrow: 1, p: 2.5 }}>
                        ...
                        <Typography fontWeight={600} fontSize={14.5} mb={0.6} color="#888" letterSpacing="-0.2px">
                            Manual Upload
                        </Typography>
                    ...
                    <Box sx={{ px: 2.5, pb: 2.5 }}>
                        <Button fullWidth onClick={(e) => { e.stopPropagation(); setUploadOpen(true); }}
                            sx={{ bgcolor: "transparent", color: "#555", textTransform: "none", fontWeight: 600, fontSize: 12.5, borderRadius: "10px", py: 1, border: "1px solid #242424", "&:hover": { bgcolor: "#141414", borderColor: "#3a3a3a", color: "#aaa" }, transition: "all 0.2s" }}>
                            Upload File
                        </Button>
                    </Box>
                </Card>
